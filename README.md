...
The goal is identifying policyholder, vehicle, and coverage characteristics associated with higher or lower expected claim costs, conditional on a claim occurring.

## Key Findings
- Insurance claim severity displays a strong right-skewed distribution, consistent with insurance
...
- Household relationship relationship variables show relatively small effects on policy and vehicle characteristics.

## Methodology
- Data cleaning and variable selection focused on pricing-relevant variables.
